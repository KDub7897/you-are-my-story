...
const P = {
  // Vaggers collection
  vaggers_classic:    '/images/vaggers-classic.jpg',
  vaggers_googly:     '/images/vaggers-googly.jpg',
  vaggers_pucker:     '/images/vaggers-pucker.jpg',
  vaggers_bondage:    '/images/vaggers-bondage.jpg',
  vaggers_kit:        '/images/vaggers-kit.jpg',
  vaggers_thong:      '/images/vaggers-thong.jpg',
  vaggers_road:       '/images/vaggers-road.jpg',
  // Cluck Norris
  cluck_classic:      '/images/cluck-classic.jpg',
  cluck_vaggers:      '/images/cluck-vaggers.jpg',
  // Bitmojis - Kelli
  bm_wanna:           '/images/bm-wanna.jpg',
  bm_poot:            '/images/bm-poot.jpg',
  bm_jail:            '/images/bm-jail.jpg',
  bm_squirrel:        '/images/bm-squirrel.jpg',
  bm_platypus:        '/images/bm-platypus.jpg',
  bm_fuse:            '/images/bm-fuse.jpg',
  // Bitmojis - couple
  bm_couple_sit:      '/images/bm-couple-sit.jpg',
  bm_couple_run:      '/images/bm-couple-run.jpg',
  bm_couple_pose:     '/images/bm-couple-pose.jpg',
  bm_couple_scared:   '/images/bm-couple-scared.jpg',
  bm_couple_heart:    '/images/bm-couple-heart.jpg',
  // Real photos
  real_taboo:         '/images/real-taboo.jpg',
  real_harley:        '/images/real-harley.jpg',
  real_date1:         '/images/real-date1.jpg',
  real_date2:         '/images/real-date2.jpg',
  real_date3:         '/images/real-date3.jpg',
  real_selfie1:       '/images/real-selfie1.jpg',
  real_selfie2:       '/images/real-selfie2.jpg',
  real_selfie3:       '/images/real-selfie3.jpg',
  // Pets / misc
  stella:             '/images/stella.jpg',
  couch_dog:          '/images/couch-dog.jpg',
  raccoon:            '/images/raccoon.jpg',
  the_gang:           '/images/the-gang.jpg',
  // Art
  art_superhero:      '/images/art-superhero.jpg',
  art_kissing:        '/images/art-kissing.jpg',
  art_snake_penguin:  '/images/art-snake-penguin.jpg',
  // Hero
  hero_chase:         '/images/hero-chase.jpg',
};
...
const CLUCK = [
  "what doin? 🐔",
  "Cluck Norris approves. He doesn't know of what.",
  "Cluck Norris has entered the chat. Cluck Norris is kinky about it.",
  "Cluck Norris and Dr. Vaggers are not available. They are busy. Do not ask.",
  "Cluck Norris would like a moment of silence. For Cluck Norris.",
  "Cluck Norris does NOT approve of this answer. Cluck Norris approves of everything else.",
  "what doin 🐔🐔",
  "Cluck Norris is watching. From the coop. Specifically.",
  "Vaggers is not seeing this. Cluck Norris is. With interest.",
  "Cluck Norris reminds you: the Pucker Star is not a place. It is a STATE OF MIND.",
  "Cluck Norris would like to leave. Wait — he's back. Carry on.",
  "Whatcha doin' over there? 🐔 Cluck Norris asking for a friend.",
  "Cluck Norris has thoughts. Cluck Norris keeps them to himself. Mostly.",
  "Cluck Norris is taking notes. Suspicious notes.",
  "🐔 'I'm just here for the snacks.' — Cluck Norris",
];
...
const WANNA = [
  ...
  "WANNA but make it ✨romantic✨",
  "WANNA but make it filthy",
  "Just checking in: WANNA?",
  "Oh hey. WANNA?",
  "WANNA on a scale of 1 to absolutely.",
  "WANNA — but with a snack first.",
  "I'm asking. WANNA.",
  "WANNA, said with eye contact.",
  "WANNA. (whispered.)",
  "WANNA. (yelled.)",
  "WANNA. Don't make me ask twice.",
  "WANNA — sponsored by Vaggers Private Practice.",
  "Cluck Norris also wants to know — WANNA?",
  "WANNA. The answer is yes. You just don't know it yet.",
];
...
const REMEMBER = [
  { slot:'real_taboo', q:"Where were we and what were we playing?", a:"Taboo night — and I was crying laughing.", pts:5 },
  { slot:'real_harley', q:"Halloween — what was I dressed as and who'd I scare?", a:"Harley Quinn. The neighbour with the dog.", pts:5 },
  { slot:'real_date1', q:"This date — what restaurant and what did I order?", a:"Anniversary dinner — the steak.", pts:5 },
  { slot:'real_date2', q:"This day — what did we do after?", a:"Walked home and stayed up watching old shows.", pts:5 },
  { slot:'real_date3', q:"This trip — what was the moment that made the whole day?", a:"You laughed so hard you couldn't breathe.", pts:5 },
  { slot:'real_selfie1', q:"Why am I making that face?", a:"Because you said something filthy and I had to recover.", pts:3 },
  { slot:'real_selfie2', q:"Where were we right before this photo?", a:"Walking back from coffee. You'd just kissed me.", pts:3 },
  { slot:'real_selfie3', q:"What did you say RIGHT before this photo?", a:"You said 'just one more.'", pts:3 },
  { slot:'vaggers_classic', q:"Dr. Vaggers — full credentials?", a:"Quackington Medical School. Very impressive bill.", pts:10 },
  { slot:'vaggers_googly', q:"Who is this and what is her role?", a:"Nurse Beak. Sidekick. Submitted formal request for a larger role.", pts:10 },
  { slot:'vaggers_pucker', q:"Name the move.", a:"The Pucker Star.", pts:10 },
  { slot:'vaggers_bondage', q:"Professional setting — describe it medically.", a:"Vaggers in professional attire. As regulated.", pts:10 },
  { slot:'vaggers_kit', q:"Vaggers' starter kit — name two items.", a:"Stethoscope. The rubber chicken.", pts:10 },
  { slot:'cluck_classic', q:"Who is this and what is his vibe?", a:"Cluck Norris. Kinky chicken. Vaggers loves him.", pts:10 },
  { slot:'cluck_vaggers', q:"What is happening in this photo?", a:"Cluck Norris and Vaggers. She looks happy. She will not approve.", pts:10 },
  { slot:'bm_wanna', q:"Famous question — full text?", a:"WANNA?", pts:3 },
  { slot:'bm_poot', q:"Move name?", a:"POOT.", pts:3 },
  { slot:'bm_jail', q:"Sentence?", a:"JAIL.", pts:3 },
  { slot:'bm_squirrel', q:"Mental state?", a:"Squirrel Brain.", pts:3 },
  { slot:'bm_platypus', q:"Famous quote attached to this image?", a:"Who's Pus is This?", pts:3 },
  { slot:'bm_couple_sit', q:"What were we talking about that night?", a:"Forever.", pts:5 },
  { slot:'bm_couple_run', q:"What were we running from?", a:"Nothing. Towards each other.", pts:5 },
  { slot:'bm_couple_pose', q:"What's our actual pose called?", a:"The Demon and the Python.", pts:5 },
  { slot:'stella', q:"Name and trademark feature?", a:"Stella. Drawn-on eyebrows.", pts:5 },
  { slot:'art_snake_penguin', q:"Animal personas — who is who?", a:"Python = Crystal. Penguin = Kelli.", pts:10 },
  { slot:'art_kissing', q:"What is this art piece — and what does it mean to us?", a:"Us. Through every version of forever.", pts:10 },
  { slot:'art_superhero', q:"Superhero version — who is who?", a:"You're the hero. I'm the chaos.", pts:10 },
  { slot:'the_gang', q:"Name as many as you can.", a:"Vaggers, Cluck, Stella, Snake, Penguin, the gang.", pts:10 },
];
